...
def build_regime_map(x_start, a_range, b_range, time_range, f):
    ...
    peq = open("C:\\users\\user\\desktop\\data\\eqX2Gt2X1.txt", 'w')
    c2 = open('C:\\users\\user\\desktop\\data\\cycle2.txt', 'w')
    c3 = open('C:\\users\\user\\desktop\\data\\cycle3.txt', 'w')
    c4 = open('C:\\users\\user\\desktop\\data\\cycle4.txt', 'w')
    c5 = open('C:\\users\\user\\desktop\\data\\cycle5.txt', 'w')
    c6 = open('C:\\users\\user\\desktop\\data\\cycle6.txt', 'w')
    c7 = open('C:\\users\\user\\desktop\\data\\cycle7.txt', 'w')
    c8 = open('C:\\users\\user\\desktop\\data\\cycle8.txt', 'w')
    c9 = open('C:\\users\\user\\desktop\\data\\cycle9.txt', 'w')
    c10 = open('C:\\users\\user\\desktop\\data\\cycle10.txt', 'w')
    c11 = open('C:\\users\\user\\desktop\\data\\cycle11.txt', 'w')
    c12 = open('C:\\users\\user\\desktop\\data\\cycle12.txt', 'w')
    c13 = open('C:\\users\\user\\desktop\\data\\cycle13.txt', 'w')
    c14 = open('C:\\users\\user\\desktop\\data\\cycle14.txt', 'w')
    c15 = open('C:\\users\\user\\desktop\\data\\cycle15.txt', 'w')
    ...
    plt.savefig("C:\\users\\user\\desktop\\a.jpg")
