\subsection{Описание модели}
    ...
    \begin{figure}
        ...
        \subfloat[\(\beta = 0.57\)]{
            \label{mainIntersect}
            \includegraphics[width=0.75\textwidth]{deterministic/two_intersection.jpg}
        }

        \subfloat[\(\beta \approx 0.582355932\)]{
            \label{mainTouch}
            \includegraphics[width=0.75\textwidth]{deterministic/one_intersection.jpg}
        }

        \subfloat[\(\beta = 0.59\)]{
            \label{mainOver}
            \includegraphics[width=0.75\textwidth]{deterministic/zero_intersection.jpg}
        } 
