\subsection{Временные ряды}
    ...
    \begin{figure}
        \centering
        \subfloat[При \(\beta = 0.4\) и \(x_0 = 0.1\)]{
            \label{time_series_x_0_1_b_0_4}
            \includegraphics[width=0.5\textwidth]{deterministic/images/time_series_x_0_1_b_0_4.jpeg}
        }
        \subfloat[При \(\beta = 0.25\) и \(x_0 = 0.1\)]{
            \label{time_series_x_0_1_b_0_25}
            \includegraphics[width=0.5\textwidth]{deterministic/images/time_series_x_0_1_b_0_25.jpg}
        }

        \subfloat[При \(\beta = 0.56\) и различных значениях \(x_0\), указанных в легенде]{
            \label{time_series_b_0_56}
            \includegraphics[width=0.5\textwidth]{deterministic/images/time_series_b_0_56.jpg}
        }

        \captionsetup{justification=centering}
        \caption{Временной ряд модели (\ref{origin})}
    \end{figure}
