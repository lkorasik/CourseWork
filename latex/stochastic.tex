\section{Стохастический анализ}
    ...
    \subsection{Описание изменений}
        ...
        \comment{А что на счет комбинации шумов? Нечто может влиять на enviroment capacity и на growth rate одновременно. Нужно понять биологический смысл разных видов шумов, чтоб понять можно ли их комбинировать.}
