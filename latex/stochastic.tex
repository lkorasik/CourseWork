\section{Стохастический анализ}
    ...
    \subsection{Бифуркация}
        ...
        Теперь перейдем к рассмотрению графиков бифуркации с разными видами шумов. На рисунках \ref{bifurcation_x_0_2_a_1_compare_beta_noise}, \ref{bifurcation_x_0_2_a_1_compare_alpha_noise} и \ref{bifurcation_x_0_2_a_1_compare_additional_noise} изображены графики бифуркации с \(\beta\)-шумом, \(\alpha\)-шумом и аддитивным щумом. Они похожи на детерминированный случай \ref{bifurcation_x_0_2_a_1_compare_no_noise}. От вида шума зависит то, как сильно размазана картинка относительно исходной. 
        ...
        \comment{Не понятно про что тут писать}
    ...
    \subsection{Матожидание}
        ...
        \comment{Думаю расписывать как получили не надо}
        ...
        Перейдем к рассмотрению графика \ref{} усредненных значений математического ожидния.
